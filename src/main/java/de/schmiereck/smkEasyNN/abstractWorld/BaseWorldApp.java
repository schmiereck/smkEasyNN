package de.schmiereck.smkEasyNN.abstractWorld;
...
public abstract class BaseWorldApp extends Application {
    ...
    public void start(final Stage primaryStage) throws Exception {
        this.prefs = Preferences.userNodeForPackage(getPreferencesClass());

        final Parent root = FXMLLoader.load(this.getFXMLResource());
