...
public class HexGridCalcRunnable implements Runnable {
    ...
    public HexGridCalcRunnable(final WorkInterface workInterface, final HexGridService hexGridService, final int xStartGridPos, final int yStartGridPos, final int xEndGridPos, final int yEndGridPos) {
