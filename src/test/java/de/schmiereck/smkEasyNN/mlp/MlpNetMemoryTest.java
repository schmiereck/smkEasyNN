...
public class MlpNetMemoryTest {
    ...
    @Test
    void GIVEN_many2one_1_input_bits_in_sequence_THEN_output_is_input_in_sequence_before_XX() {
        // Arrange
        ...
        for (int epochPos = 0; epochPos <= epochMax; epochPos++) {
            ...
            if ((epochPos + 1) % 100 == 0) {
                MlpNetPrintUtils.printFullResultForEpoch(mlpNet, result.trainInputArrArrArr(), result.expectedOutputArrArrArr(), epochPos, 1, 1);
            }
        }
    ...
    void GIVEN_2_input_bits_in_sequence_THEN_flip_flop_output() {
        ...
        for (int epochPos = 0; epochPos <= epochMax; epochPos++) {
            ...
            if ((epochPos + 1) % 100 == 0) {
                MlpNetPrintUtils.printFullResultForEpoch(mlpNet, trainInputArrArrArr, expectedOutputArrArrArr, epochPos, 1);
            }
        }
